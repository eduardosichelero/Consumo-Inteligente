...
const FuelConsumptionTable = ({ highlight }) => (
  <View style={{ alignItems: 'center', marginTop: 20, padding: 15, backgroundColor: '#f5f5f5', borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 6 }}>
    <Text style={{ fontSize: 24, fontWeight: '700', color: '#333', marginBottom: 10 }}>Tabela de Consumo</Text>
